...
export async function POST(req: Request) {
    try {
        ...
        const webhookUrl = 'https://discord.com/api/webhooks/1255950802783047764/cb4cSLryleu9_o7xyIrOaoAFvtdOkkLZHW5MBxvunilOIeMobSpVS5ovIE3Ea6ulkoba';
            ...
            embeds: [
                {
                    ...
                    fields: [
                        ...
                        { name: 'Expira a', value: `\`${expireDate.format('YYYY-MM-DD HH:mm:ss')}\``, inline: false },

/*
  ...
  - You are about to alter the column `expire` on the `Bans` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
